...
spirits =
    ...
    , { name = "Rising Heat of Stone and Sand", complexity = Low, origin = Horizons }
    , { name = "Sun-Bright Whirlwind", complexity = Low, origin = Horizons }
    , { name = "Ember-Eyed Behemoth", complexity = Med, origin = NatureIncarnate }
    , { name = "Hearth-Vigil", complexity = Med, origin = NatureIncarnate }
    , { name = "Towering Roots of the Jungle", complexity = Med, origin = NatureIncarnate }
    , { name = "Breath of Darkness Down Your Spine", complexity = High, origin = NatureIncarnate }
    , { name = "Relentless Gaze of the Sun", complexity = High, origin = NatureIncarnate }
    , { name = "Wandering Voice Keens Delirium", complexity = High, origin = NatureIncarnate }
    , { name = "Wounded Waters Bleeding", complexity = High, origin = NatureIncarnate }
    , { name = "Dances Up Earthquakes", complexity = VeryHigh, origin = NatureIncarnate }
